...
# Subplot 1
plt.subplot(2, 4, 1)
plt.scatter(power_error_case1, pd_error_q50_case1, s=1, alpha=0.3, color='b')
...
# Subplot 2
plt.subplot(2, 4, 2)
plt.scatter(power_error_case1, pd_error_ST_case1, s=1, alpha=0.3, color='b')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-500, 600)
plt.title('ST (Case 1)')
...
# Subplot 3
plt.subplot(2, 4, 3)
plt.scatter(power_error_case1, pd_error_acc_oriented_case1, s=1, alpha=0.3, color='b')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-500, 600)
...
plt.scatter(power_error_case1[~mask], pd_error_e2e_case1[~mask], s=1, alpha=0.3, color='b', label='Normal')
plt.scatter(power_error_case1[mask], pd_error_e2e_case1[mask], s=2, alpha=0.5, color='#e84393', label='SoDR')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-500, 600)
...
# Subplot 5
plt.subplot(2, 4, 5)
plt.scatter(power_error_case2, pd_error_q50_case2, s=1, alpha=0.3, color='b')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-300, 300)
...
# Subplot 6
plt.subplot(2, 4, 6)
plt.scatter(power_error_case2, pd_error_ST_case2, s=1, alpha=0.3, color='b')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-300, 300)
plt.title('ST (Case 2)')
...
# Subplot 7
plt.subplot(2, 4, 7)
plt.scatter(power_error_case2, pd_error_acc_oriented_case2, s=1, alpha=0.3, color='b')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-300, 300)
...
plt.scatter(power_error_case2[~mask], pd_error_e2e_case2[~mask], s=1, alpha=0.3, color='b', label='Normal')
plt.scatter(power_error_case2[mask], pd_error_e2e_case2[mask], s=2, alpha=0.5, color='#e84393', label='SoDR')
plt.xlabel('Power Error (MWh)')
plt.ylabel('Price Error (£/MWh)')
plt.ylim(-300, 300)
