...
- 📂 **data** — Data-related contents
  ...
  - 📂 **dataset** — Intermediary datasets generated by `dataPreProcess.py`
...
- 📂 **models** — Model storage
  ...
  - 📂 **Prices** — E2E learning models/data for supplementary testing beyond HEFTCom
  - 📂 **Rolling_PostProcess** — Rolling post-processing (Forecasting/Trading) models
- 📂 **pre-process** — Data preprocessing scripts
- 📂 **slides** — Slides for reports/presentations at ISF2024
