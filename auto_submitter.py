...
for i in range(4):
    plt.subplot(2,2,i+1)
    plt.scatter(dwd_wind_features.iloc[:,i],Wind_Generation_Forecast["q50"])
    plt.ylabel("q50")
    plt.xlabel(dwd_wind_features.columns[i])
...
for i in range(3):
    plt.subplot(1,3,i+1)
    plt.scatter(dwd_solar_features.iloc[:,i],Solar_Generation_Forecast["q50"])
    plt.ylabel("q50")
    plt.xlabel(dwd_solar_features.columns[i])
...
plt.figure(figsize=(20,10))
for quantile in range(10,100,10):
    plt.subplot(3,3,int(quantile/10))
    plt.scatter(pre_Wind_Generation_Forecast[f"q{quantile}"],Wind_Generation_Forecast[f"q{quantile}"])
    plt.ylabel("benchmark")
    plt.xlabel("now")
    plt.plot(pre_Wind_Generation_Forecast[f"q{quantile}"],pre_Wind_Generation_Forecast[f"q{quantile}"],color="red",linestyle="--")
    plt.title(f"Wind q{quantile}")
    plt.tight_layout()
    plt.grid()
...
for quantile in range(10,100,10):
    plt.subplot(3,3,int(quantile/10))
    plt.scatter(pre_Solar_Generation_Forecast[f"q{quantile}"],Solar_Generation_Forecast[f"q{quantile}"])
    plt.ylabel("benchmark")
    plt.xlabel("now")
    plt.plot(pre_Solar_Generation_Forecast[f"q{quantile}"],pre_Solar_Generation_Forecast[f"q{quantile}"],color="red",linestyle="--")
    plt.title(f"Solar Generation q{quantile}")
    plt.tight_layout()
    plt.grid()
...
for quantile in range(10,100,10):
    plt.subplot(3,3,int(quantile/10))
    plt.scatter(pre_Total_Generation_Forecast[f"q{quantile}"],Total_Generation_Forecast[f"q{quantile}"])
    plt.ylabel("benchmark")
    plt.xlabel("now")
    plt.plot(pre_Total_Generation_Forecast[f"q{quantile}"],pre_Total_Generation_Forecast[f"q{quantile}"],color="red",linestyle="--")
    plt.title(f"Total Generation q{quantile}")
    plt.tight_layout()
    plt.grid()
